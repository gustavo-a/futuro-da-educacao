  ...
  <section class="py-16">
    <div class="container">
      ...
      <div class="flex justify-center">
        <div class="timeline w-full lg:w-3/4">
          <ol>
            <li>
              <div class="content">
                <div class="titulo">
...
.timeline {
  ...
  ol {
    ...
    li {
      &::before {
        ...
        @apply .absolute .right-0 .left-0 .m-auto .block .text-center .text-white .text-2xl .rounded-full .font-sans2;
        width: 36px;
        height: 36px;
      }
      ...
      @media (max-width: 767px) {
        ...
        &:nth-of-type(even) {
          .content {
            @apply .mb-16 .pt-16 .text-center .pr-0 .pl-0;
  ...
  .titulo {
    @apply .font-sans2 .text-xl .italic;
  }
